...
IF(GUROBI_FOUND)
  ...
  FILE(GLOB gurobilibs "${Gurobi_LIBRARY_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}gurobi??${CMAKE_SHARED_LIBRARY_SUFFIX}" "${Gurobi_LIBRARY_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}gurobi??${CMAKE_SHARED_MODULE_SUFFIX}")
  ...
  STRING(REPLACE "${CMAKE_SHARED_MODULE_SUFFIX}" "" gurobilibs "${gurobilibs}")
